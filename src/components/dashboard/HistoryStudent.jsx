...
export default function HistoryStudent({ currentUser }) {
  ...
  useEffect(() => {
    const getAdoption = async () => {
      try {
        const res = await axios.get(`/adoptions/history/${selectedAdoption?.adopter?._id}/${currentUser?.user?._id}`, {
          headers: { "x-access-token": currentUser.token },
        });
    ...
    const getContract = async () => {
      try {
        const res = await axios.get(`/contracts/history/${selectedAdoption?.adopter?._id}/${currentUser?.user?._id}`, {
          headers: { "x-access-token": currentUser.token },
        });
    ...
    const getContact = async () => {
      try {
        const res = await axios.get(`/conversations/find/${selectedAdoption?.adopter?._id}/${currentUser?.user?._id}`, {
          headers: { "x-access-token": currentUser.token },
        });
